...
[![https://i.ytimg.com/vi/pBbt5CO4q30/hq720.jpg](https://i.ytimg.com/vi/pBbt5CO4q30/hq720.jpg)](https://youtu.be/pBbt5CO4q30)

## Previously…

In the last video, I talked about how I switched out from [Firefox](https://www.firefox.com) once again and chose [LibreWolf](https://librewolf.net) as my primary web browser. In this video, I’ll walk you through my high-level setup on LibreWolf, which includes settings and web extensions I chose to make it my daily driver.

## Basic Configuration

As LibreWolf isn’t available on [Void Linux](https://voidlinux.org) repos, I installed it from [Flathub](https://flathub.org). There’s not a lot to configure, actually.
...
2. Setting [Brave Search](https://search.brave.com) as the search engine
...
### 2. [Spoof Timezone](https://addons.mozilla.org/en-US/firefox/addon/spoof-timezone)
...
### 4. [KeePassXC-Browser](https://addons.mozilla.org/en-US/firefox/addon/keepassxc-browser)
...
### 5. [Raindrop.io](https://addons.mozilla.org/en-US/firefox/addon/raindropio)

[Raindrop.io](http://Raindrop.io) helps me maintain my web browser extensions just as it did on Firefox and Brave before.
...
### 7. [Grammarly](https://addons.mozilla.org/en-US/firefox/addon/grammarly-1)
...
### 8. [Emoji](https://addons.mozilla.org/en-US/firefox/addon/emoji-sav)

Emoji is an extension that provides easy access to hundreds of emojis when I need to be expressive on the web.

### 9. [Tab Renamer](https://addons.mozilla.org/en-US/firefox/addon/rename-tabs)
